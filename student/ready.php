      ...
      <div class="card w-full max-w-2xl shadow-xl rounded-2xl">
        ...
        <div class="card-body p-6">
          ...
          <div class="mb-6 space-y-1">
            <h6><strong>Name:</strong> Muhammad Ibrahim Musa</h6>
            <h6><strong>Reg No:</strong> 2021/CSC/1234</h6>
            <h6><strong>Course Title:</strong> Introduction to Programming</h6>
            <h6><strong>Course Code:</strong> CSC 201</h6>
            <h6 class="flex items-center gap-2 text-primary">
              <i class="bi bi-clock-history"></i>
              <strong>Exam Time:</strong> 1 hour 30 minutes
            </h6>
          </div>
          ...
          <div class="text-center">
            <a href="test.php" class="btn btn-primary px-6 py-2 text-lg rounded-full">
              Get Started
            </a>
          </div>
