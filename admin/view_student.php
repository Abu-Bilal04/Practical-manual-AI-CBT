            ...
            <a href="#" class="dropdown-item">
              ...
              <?php
                if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['change_password'])) {
                    ...
                    if ($stmt->execute()) {
                        echo "<script>window.open('view_student.php?msg=update', '_self');</script>";
                    } else {
        ...
        <div class="page-header">
          <div class="page-block">
            <div class="page-header-title">
              <h5 class="mb-0 font-medium">Manage student</h5>
            </div>
            <ul class="breadcrumb">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                      <?php
                        $sql = "SELECT s.id, s.fullname, s.regno, l.level
                                FROM student s
                        ...
                        if (!$result) {
                            die("Query failed: " . mysqli_error($dbcon)); // helpful debug
                        }
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            echo "<tr><td colspan='5' class='text-center'>No student found</td></tr>";
                        }
                        ?>
