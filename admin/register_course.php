        ...
        <div class="page-header">
          <div class="page-block">
            <div class="page-header-title">
              <h5 class="mb-0 font-medium">Register course</h5>
            </div>
            <ul class="breadcrumb">
              <li><a href="index.php">Home</a></li>
              <i class="bi bi-arrow-right-circle"></i>
              <li><a href="register_course.php">Course</a></li>
            </ul>
          </div>
        </div>
            ...
            <div class="col-span-12">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <input type="text" class="form-control mb-3" id="floatingInput" placeholder="Enter course code" />
                  <input type="text" class="form-control mb-3" id="floatingInput" placeholder="Enter course title" />
