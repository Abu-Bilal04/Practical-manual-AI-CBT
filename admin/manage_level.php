            ...
            <a href="#" class="dropdown-item">
              ...
              <?php
                if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['change_password'])) {
                    ...
                    if ($stmt->execute()) {
                        echo "<script>window.open('manage_level.php?msg=update', '_self');</script>";
                    } else {
        ...
        <div class="grid">
            <form method="post">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <input type="text" class="form-control" id="floatingInput" name="level_name" placeholder="Enter level" />
                <div class="grid grid-cols-12 gap-x-12 mt-2">
                    <button class="btn btn-primary" name="register_level">Register</button>
                </div>
                </div>
              </div>
            </div>
                    ...
                    <tbody>
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            while ($row = mysqli_fetch_assoc($result)) {
                                echo "<tr>";
                                echo "<td>" . $sn++ . "</td>";
                                echo "<td>" . $row['level'] . "</td>";  // use correct column name
                                echo "<td><a href='delete/delete_level.php?id=" . $row['id'] . "' class='btn btn-danger btn-sm'>Delete</a></td>";
                                echo "</tr>";
                            }
                        } else {
                            echo "<tr><td colspan='3' class='text-center'>No level found</td></tr>";
                        }
